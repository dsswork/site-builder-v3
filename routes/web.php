...
Route::middleware('auth')
    ...
    ->group(function () {
        ...
        Route::post('pages/{page}/{template}/store-block',
            [Admin\PageController::class, 'storeBlock'])
        ...
        Route::post('menus/{menu}/{template}/store-block',
            [Admin\MenuController::class, 'storeBlock'])
        ...
        Route::post('settings/{setting}/{template}/store-block',
            [Admin\SettingController::class, 'storeBlock'])
        ...
        Route::get('history', [Admin\EventController::class, 'index'])
            ->name('events.index');
    });

require __DIR__ . '/auth.php';

Route::get('{slug?}/{any?}/{some?}', [SiteController::class, 'index'])
    ->name('web.index');
