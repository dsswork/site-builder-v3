        ...
        <header>
            <nav class="container navbar navbar-expand-lg ">
                <div class="container-fluid">
                    <!-- site logo -->
                    <a class="nav-logo p-0" href="{{ route('web.index') }}">
                        <img src="{{ $settings['header-logo']['Logo'] }}" alt="logo"></a>
                    <!-- navigation button  -->
            ...
            <div class="row footer-nav-icon">
                ...
                <div
                    ...
                    <div
                        ...
                        @foreach($settings['social']['blocks'] ?? [] as $social)
                            <a href="{{ $social['Link'] }}" target="_blank" class="p-0">
                                <i class="{{ $social['Icon'] }}">
                                </i></a>
                        @endforeach
                    </div>
